...
public:
    ...
    void CountFrameLocated();
    void CountFrameRelocalizated();
    void CountFrameLoop();
    void CountFrameMerge();

    std::string GetNameInitialFrame();
    std::string GetNameLastFrame();
    unsigned int GetNumFramesLocated();
    unsigned int GetNumFramesRelocalizated();
    unsigned int GetNumFramesLoop();
    unsigned int GetNumFramesMerge();
...
protected:
    ...
    // Map stats
    std::string mstrInitialFrameName;
    std::string mstrLastFrameName;

    unsigned int mnNumLocatedFrames;
    unsigned int mnNumRelocalizations;
    unsigned int mnNumLoops;
    unsigned int mnNumMerges;
