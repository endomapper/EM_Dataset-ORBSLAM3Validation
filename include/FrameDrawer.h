...
public:
    ...
    cv::Mat DrawFrame(float imageScale=1.f, bool bShowInColor = false);
    cv::Mat DrawRightFrame(float imageScale=1.f, bool bShowInColor = false);
...
protected:
    ...
    void DrawFrameInfo(cv::Mat &im, cv::Mat &imText);

    // Info of the frame to be drawn
    cv::Mat mIm, mImRight;
    cv::Mat mImBGR, mImRightBGR;
    int N;
